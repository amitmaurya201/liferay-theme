 <#--**********************************
            logo Nav header start
***********************************-->
<div class="nav-header">
	
		<a class="brand-logo" href="${site_default_url}" title="<@liferay.language_format arguments="${site_name}" key="go-to-x" />">
			<img class="logo-abbr" alt="${logo_description}" height="${site_logo_height}" src="${site_logo}" width="${site_logo_width}" />
		</a>
...
***********************************-->
			...
			***********************************-->	
				...
				***********************************-->
					...
					<li class="nav-item" id="header-info" style="cursor: pointer; border-left: 1px solid rgba(255, 255, 255, 0.12);">
						<@liferay.user_personal_bar/> 
						<div class="header-info" >
							<h6><span>${user.getFirstName()}</span><span> ${user.getLastName()}</span></h6>
